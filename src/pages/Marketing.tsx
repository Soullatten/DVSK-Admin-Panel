            ...
            <div className="w-full px-6 py-6">
                    ...
                    <div className="flex items-center gap-2">
                        <button className="flex items-center gap-1.5 bg-white border border-[#d1d5db] text-[#1a1a1a] text-[13px] font-semibold px-3 py-1.5 rounded-lg hover:bg-[#f7f7f7] shadow-sm transition-colors">
                            <svg className="w-4 h-4 text-[#5c5f62]" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6">
                                ...
                                <path d="M7 3.5C8.5 3.5 9.5 5 9.5 7" strokeLinecap="round" />
                                <path d="M9.5 9.5L16 16" strokeLinecap="round" />
                ...
                <div className="bg-white rounded-xl border border-[#e8e8e8] shadow-sm overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <tr className="border-b border-[#f5f5f5] hover:bg-[#fafafa] transition-colors cursor-pointer">
                                <td className="px-4 py-3">
                                    <div className="flex items-center gap-2">
                                        <Globe className="w-4 h-4 text-[#5c5f62]" strokeWidth={1.5} />
                            ...
                            {suggestions
                                ...
                                .map((s) => (
                                    <tr key={s.id} className="border-b border-[#f0f0f0] bg-[#faf8ff] hover:bg-[#f3f0ff] transition-colors">
                                        <td className="px-4 py-3" colSpan={3}>
                                            <div className="flex items-center gap-2 text-[13px] font-semibold text-[#6d28d9]">
                                        ...
                                        <td className="px-4 py-3 text-right">
                                            <button
                                                ...
                                                className="p-1 hover:bg-[#ede9fe] rounded-md transition-colors text-[#9ca3af] hover:text-[#7c3aed]"
                                            >
                                                <X className="w-4 h-4" />
                                            </button>
                                        </td>
                    ...
                    <div className="py-4 text-center text-[13px] text-[#5c5f62]">
                        <a href="#" className="hover:underline">Learn more about markets</a>
                    </div>
                </div>
            </div>
        </div>
